...
public class Solution {
    ...
    public static boolean isModifierSet(int allModifiers, int specificModifier) {
      /*  String s1 = String.format("%8s", Integer.toBinaryString(allModifiers & 0xFF)).replace(' ', '0');
        System.out.println(s1);
        s1 = String.format("%8s", Integer.toBinaryString(specificModifier & 0xFF)).replace(' ', '0');
        System.out.println(s1);*/
